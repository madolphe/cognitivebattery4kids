...
function scene_tutorial6() {
    ...
    noStroke();
    textAlign(CENTER);
    text(text_tutorial_5_0, pos_tutorialtext_x1, pos_tutorialtext_y2 - 3 * shift_text_y2);
    text(text_tutorial_5_1, pos_tutorialtext_x1, pos_tutorialtext_y2 - 2 * shift_text_y2);
    text(text_tutorial_5_2, pos_tutorialtext_x1, pos_tutorialtext_y2 - 1 * shift_text_y2);
    pop();
    scene_practice_tutorial();
}
